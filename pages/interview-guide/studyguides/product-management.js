...
const guides = roleData["interviewGuide"].filter(resource => resource.category.toLowerCase() === "guide");
            ...
            <div style={{backgroundColor: '#f1f1f6',
                ...
                <Card >
                    <Stack justify="center" spacing={5} >
                        ...
                        <Center>
                          <Text textStyle={'subContent'} color="gray" mr="10px">Product Management - Interviews Guides</Text>
