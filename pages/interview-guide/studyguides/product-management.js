...
const guides = roleData["interviewGuide"].filter(resource => resource.category.toLowerCase().includes("guide"));
const videos = guides.filter(resource => (resource.type.toLowerCase() === "video"))
export default function InterviewGuide() {
  //console.log(skills)

  const [resources, setResources] = useState(guides);
  return (
            ...
            <div style={{backgroundColor: '#f1f1f6',
                ...
                <Card >
                    <Stack justify="center" spacing={5} >
                        ...
                        <Wrap justify="center">
                          <TabsMenuIG selection={3}  search='product-management' ></TabsMenuIG>
                        </Wrap>
                        <Center>
                          ...
                          <Text textStyle={'profileContent'} color="gray"> - Interviews Guides ({resources.length} found)</Text>
                        </Center>
