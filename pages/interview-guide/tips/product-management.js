...
const tips = roleData["interviewGuide"].filter(resource => resource.category.toLowerCase() === "tips");
            ...
            <div style={{backgroundColor: '#f1f1f6',
                ...
                <Card >
                    <Stack justify="center" spacing={5} >
                        ...
                        <Center>
                          <Text textStyle={'subContent'} color="gray" mr="10px">Product Management - Interviews Tips</Text>
